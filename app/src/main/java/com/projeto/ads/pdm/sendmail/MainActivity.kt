package com.projeto.ads.pdm.sendmail
...
import com.projeto.ads.pdm.sendmail.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        amb.sendBt.setOnClickListener{
            ...
            chooseIntent.putExtra(EXTRA_INTENT, sendMailIntent)
